...
check_file "app/api/upload/route-enhanced.js" "Enhanced upload (optional)"
check_file "app/api/files/[filename]/route-enhanced.js" "Enhanced file ops (optional)"
echo ""

echo -e "${YELLOW}[3/5] Verifying Security Configurations...${NC}"
echo "─────────────────────────────────────────────────────────────"
check_file "middleware.js" "Security middleware"
check_file "middleware-advanced.js" "Advanced middleware (optional)"
...
check_content "docker-compose.js" "cap_drop" "Docker capabilities"
